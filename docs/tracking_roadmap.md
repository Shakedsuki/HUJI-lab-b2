...
_Generated 2026-05-02 04:35._ Re-run with `chaos roadmap`.
...
| **WARN** | 17 | tracking.csv exists, dropout/peak ω in WARN band |
...
| `th1_p044_th2_m001` | WARN | 1.95% | 619 | 0 | 0/0 | 0 | 0/0 | 2.8px | 1075 | 2026-05-01 | review verification.png |
...
| `th1_m179_th2_p089` | FAIL | 0.64% | 8051 | 2617 | 2450/46 | 1567 | 252/589 | 20.5px | 2647 | 2026-05-01 | dropout 0.64% — re-track or HSV tune |
...
| `th1_p153_th2_p090` | FAIL | 0.67% | 5281 | 1848 | 367/5 | 1504 | 280/614 | 23.8px | 2685 | 2026-05-02 | dropout 0.67% — re-track or HSV tune |
| `th1_p160_th2_m001` | FAIL | 1.80% | 7403 | 1330 | 404/6 | 1072 | 11/365 | 17.7px | 1888 | 2026-05-02 | dropout 1.8% — re-track or HSV tune |
| `th1_p176_th2_p180` | FAIL | 0.85% | 6448 | 1959 | 1550/24 | 1263 | 15/402 | 21.7px | 2112 | 2026-05-02 | dropout 0.85% — re-track or HSV tune |
| `th1_p180_th2_p090` | FAIL | 1.15% | 7004 | 1148 | 0/0 | 987 | 16/347 | 15.5px | 1652 | 2026-05-02 | dropout 1.15% — re-track or HSV tune |

## What to do next

- **17 clips landed in WARN.** Inspect `measurements/<stem>/verification.png`; if acceptable, mark verified; otherwise `chaos fix <stem>`.
